...
docker exec fraud-detection-module sh -c "/home/rank-cross-graph-quasi-cliques-sorted.sh /home/input/max-clique/mcgqc /home/input/cleaned-data/participacoes-itens.csv >  /home/output/rank-cross-graph-quasi-cliques_updated"
