...
sample_part = part_itens.head(100)
sample_part.to_csv('/dados01/workspace/ufmg_2021_m04/sample/valores.csv',sep=";",index=False)

dict_itens= sample_part.set_index("id_item_licitacao").to_dict()
print(dict_itens)
