...
docker exec -d pattern-mining-module /home/multidupehack/maximal-cross-graph-quasi-cliques.sh /home/input/vinculos-com-peso.csv > /home/output/mcgqc

docker exec metrics-module /home/get-metrics.sh /home/config.json 
docker exec fraud-detection-module /home/rank-cross-graph-quasi-cliques.sh /home/input/max-clique/mcgqc /home/input/cleaned-data/read-database-licitacao.csv > /home/output/rank_cnpjs.txt
