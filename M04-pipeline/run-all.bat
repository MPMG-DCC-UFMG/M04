...
docker exec fraud-detection-module sh -c "/home/rank-cross-graph-quasi-cliques.sh /home/input/max-clique/mcgqc /home/input/cleaned-data/participacoes-itens.csv > /home/output/rank_cnpjs"
